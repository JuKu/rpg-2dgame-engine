...
public class TransformationUtils {
    ...
    public static Matrix4f getOrtoProjModelMatrix(Light2D light, Matrix4f orthoMatrix, Matrix4f cachedModelMatrix, Matrix4f dest) {
        return getOrtoProjModelMatrix(light.getRotation(), light.getPosition(), light.getScale(), orthoMatrix, cachedModelMatrix, dest);
    }
